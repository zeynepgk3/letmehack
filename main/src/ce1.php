...
if (isset($_POST['ce1'])) {
    if ($_SESSION[$_SESSION['uid']]['up'] == 1) {
        exec("sudo /usr/local/bin/docker rm -rf " . $_SESSION['uid'] . "-ce1", $output, $retval);
        $_SESSION[$_SESSION['uid']]['up'] = 0;
    } else {
        exec("sudo /usr/local/bin/docker run --rm -d --name " . $_SESSION['uid'] . "-ce1 -p 0:80 ce1", $output, $retval);
                    ...
                    <div class="post-body">
                        <div class="entry-header">
                            ...
                            <h2 class="entry-title">
                                Command Execution 1. Laboratuvar - WhoIs Aracı
                            </h2>
                            <!-- <div class="post-meta">
