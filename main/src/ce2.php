...
if (isset($_POST['ce2'])) {
    if ($_SESSION[$_SESSION['uid']]['up'] == 1) {
        exec("sudo /usr/local/bin/docker rm -rf " . $_SESSION['uid'] . "-ce2", $output, $retval);
        $_SESSION[$_SESSION['uid']]['up'] = 0;
    } else {
        exec("sudo /usr/local/bin/docker run --rm -d --name " . $_SESSION['uid'] . "-ce2 -p 0:80 ce2", $output, $retval);
        $_SESSION[$_SESSION['uid']]['up'] = 1;
    }
}
if (isset($_SESSION[$_SESSION['uid']]['up'])) {
    exec("sudo /usr/local/bin/docker inspect --format='{{range \$p, \$conf := .NetworkSettings.Ports}}{{(index \$conf 0).HostPort}} {{end}}' " . $_SESSION['uid'] . "-ce2", $port, $retval);
}
?>
            ...
            <div class="col-lg-8 mb-5 mb-lg-0">
                    ...
                    <div class="post-body">
                        <div class="entry-header">
                            ...
                            <h2 class="entry-title">
                                Command Execution 2. Laboratuvar - WhoIs Aracı
                            </h2>
                            <!-- <div class="post-meta">
                        ...
                        <div class="entry-content">
                            ...
                            Lab Açıklaması <br>
                            Bu lab içerisinde size whois sorguları yapabileceğiniz bir site verdik, bu sitede alan adını yazıp sorguladığınızda o alan adı ile ilgili bilgileri görebiliyorsunuz. geçen seferkinden farklı olarak ufak birkaç önlem aldık ama sen bunları atlatırsın. Sana inanıyoruz, iyi şanslar :) <br>
                            </p>
                        </div>
                ...
                <div class="comments-form border-box">
                    ...
                    ?>
                            ...
                            <a target="_blank" href="http://localhost:<?php echo $port[0]; ?>/ce2.php">http://localhost:<?php echo $port[0]; ?> </a>
                    <?php
                        }
                    }
                    ?>
